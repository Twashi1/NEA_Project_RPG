...
std::array<Tile::Properties, (uint16_t)Tile::ID::MAX> Tile::m_Properties = {
	Tile::Properties("void",			false,	false,	0.0f, Vivium::Vector2<int>(INT_MAX)),
	Tile::Properties("ground",			false,	false,	0.0f, Vivium::Vector2<int>(1, 0)),
	Tile::Properties("grass",			false,	false,	0.0f, Vivium::Vector2<int>(2, 0)),
	Tile::Properties("tree_0",			true,	true,	3.0f, Vivium::Vector2<int>(3, 1)),
	Tile::Properties("tree_1",			false,	false,	0.0f, Vivium::Vector2<int>(3, 0)),
	Tile::Properties("sand",			false,	false,	0.0f, Vivium::Vector2<int>(4, 0)),
	Tile::Properties("water",			false,	false,	0.0f, Vivium::Vector2<int>(5, 0)),
	Tile::Properties("bush",			true,	true,	1.0f, Vivium::Vector2<int>(6, 0)),
	Tile::Properties("bush_fruit",		true,	true,	1.5f, Vivium::Vector2<int>(7, 0)),
	Tile::Properties("amethyst_node",	true,	true,	3.0f, Vivium::Vector2<int>(8, 0))
};
...
Tile::Properties::Properties(const char* name, bool isPhysical, bool isMineable, float mining_time, AtlasData atlas_data)
	: name(name), isPhysical(isPhysical), isMineable(isMineable), mining_time(mining_time), atlas_data(atlas_data) {}
