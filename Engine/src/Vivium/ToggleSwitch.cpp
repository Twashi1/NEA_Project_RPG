...
namespace Vivium {
	Ref(Shader) ToggleSwitch::m_DefaultShader;
	Ref(Texture) ToggleSwitch::m_DefaultOnTexture;
	Ref(Texture) ToggleSwitch::m_DefaultOffTexture;
	Ref(Texture) ToggleSwitch::m_DefaultPressedOnTexture;
	Ref(Texture) ToggleSwitch::m_DefaultPressedOffTexture;
	...
	ToggleSwitch::ToggleSwitch(Ref(Quad) quad, CallbackFunc_t callback, bool default_state)
